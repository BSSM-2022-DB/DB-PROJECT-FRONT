...
//            console.log(data);
    ...
    data.map((pro) => {
        if ( pro.line_name == lineValue ) { // pro.line_name == props.line
            rt.push(
                    <div id="cham-list">
                        <span id="cham-name">
                            <img src={`https://opgg-static.akamaized.net/meta/images/lol/champion/${pro.cham_id}.png?image=c_crop,h_103,w_103,x_9,y_9/q_auto,f_webp,w_64&v=1668401198263`} alt="champion-img" />
                            {pro.cham_name}
                        </span>
